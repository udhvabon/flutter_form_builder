...
class FormBuilderCheckboxGroup extends StatefulWidget {
  ...
  @override
  _FormBuilderCheckboxGroupState createState() =>
      _FormBuilderCheckboxGroupState();
}

class _FormBuilderCheckboxGroupState extends State<FormBuilderCheckboxGroup> {
            ...
            children: widget.options.map((option) {
              return InkWell(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    _leading(field, widget.options.indexOf(option)),
                    option,
                    _trailing(field, widget.options.indexOf(option)),
                  ],
                ),
              );
            }).toList(),
